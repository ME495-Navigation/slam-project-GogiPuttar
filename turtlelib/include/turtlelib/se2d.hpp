...
namespace turtlelib
{
    ...
    /// \brief Compute the transformation corresponding to a rigid body following a constant twist (from its original frame) for one time-unit
    /// \param twist - twist to be applied
